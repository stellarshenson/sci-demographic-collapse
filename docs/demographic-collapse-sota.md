...
The distilled, calibrated design that survived the full E1-E50 campaign - 463 pre-registered
hypotheses across fifty rounds. It is an age-structured cohort-component (Leslie) core of national
...
3-47 and the core modules `src/sci_demographic_collapse/coremodel.py` (Leslie) and `emergent.py` (the
