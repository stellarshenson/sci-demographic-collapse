...
| E41 | calibration extension to multi-observable targets (research round: Wave 1 targets complete, Wave 2 blocker resolution complete [18 findings: 9 RESOLVED / 9 AMENDED / 0 BLOCKER, `reports/e41_blocker_resolutions.json`], Wave 3 implementation user-gated; `docs/e41-acceptance-criteria.md`) | - | 0 | research round (in progress) |
...
its own source, leaving a thin margin). These are recorded as Wave-3 caveats, not silently marked
resolved; the model stays untouched.
