...
| E41 | calibration extension to multi-observable targets (research round: Wave 1 targets complete, Wave 2 blocker resolution complete [18 findings: 9 RESOLVED / 9 AMENDED / 0 BLOCKER; round-3 re-review APPROVE ×2, W2.6 bar holds; `reports/e41_blocker_resolutions.json`], Wave 3 implementation user-gated; `docs/e41-acceptance-criteria.md`) | - | 0 | research round (in progress) |
